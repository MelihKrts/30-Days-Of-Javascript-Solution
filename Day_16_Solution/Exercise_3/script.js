...
// Day 16 Exercise Level 3 Solution
...
for (const user in txtParse) {
    if (txtParse.hasOwnProperty(user)) {
        const skillsCount = txtParse[user].skills.length;
