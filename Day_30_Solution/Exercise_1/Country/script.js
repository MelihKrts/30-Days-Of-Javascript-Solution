...
//     countryBox.classList.add("country-card");

//     const countryImgBox = document.createElement("div");
//     countryImgBox.classList.add("country-img-area");

//     const countryNameBox = document.createElement("div");
//     countryNameBox.classList.add("country-name");

//     const countryInfoBox = document.createElement("div");
//     countryInfoBox.classList.add("country-info");
//     countryInfoBox.setAttribute("id", "itemlist");

//     // showing country flag image
...
//     // countryBox div showing ınfo child

//     countryBox.appendChild(countryImgBox);
//     countryBox.appendChild(countryNameBox);
//     countryBox.appendChild(countryInfoBox);

//     // image showing div inside div

//     countryImgBox.appendChild(countryFlag);

//     // country name div showing
//     countryNameBox.appendChild(countryName);

//     // contry capital,populaton,langugae showing

//     countryInfoBox.appendChild(countryCapital);
//     countryInfoBox.appendChild(countryLanguages);
//     countryInfoBox.appendChild(countryPopulation);

//     // container showing div code
